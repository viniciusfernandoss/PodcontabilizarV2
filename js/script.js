...
const guestsData = [
    { name: "Genyffer Queiroz", role: "Fundadora Gerir Conexões", img: "../img/foto-convidado7.webp", link: "https://youtu.be/EZKtt5yV1pM?si=5D_BZTYQ5p075DFZ" },
    { name: "Claudiane Delis", role: "Especialista em Legalização", img: "../img/foto-convidado6.webp", link: "https://youtu.be/XIzQKRRmxPo?si=kpkNs38Ux7sXa8CS" },
    { name: "Rodrigo Gonzaga", role: "Consultor Empresarial", img: "../img/foto-convidado5.webp", link: "https://youtu.be/zWk2neCHXas?si=QVaxTAR0073vIrgo" },
    { name: "Yuri Rocha", role: "Contador", img: "../img/foto-convidado4.webp", link: "https://youtu.be/5AsSa7eC1MM?si=DCLkHdnG3_YCyhUy" },
    { name: "Elvis Barbosa", role: "CEO Pontuar Contabilidade", img: "../img/foto-convidado2.webp", link: "https://youtu.be/7g2WPnGD9Zc?si=VMs6V29qJdLoEXdB" },
    { name: "Simoni Luduvice", role: "Criadora do método Coachibilidade", img: "../img/foto-convidado3.webp", link: "https://youtu.be/nNiGXR5MocY?si=c7D4-7JlljlCS2AK" },
    { name: "Weslly Barbosa", role: "Empresário Contábil", img: "../img/foto-convidado1.webp", link: "https://youtu.be/kWc-beGYVrs?si=OHABOtdWP-Q-o5wx" },
    { name: "João Silva", role: "Empresário Contábil", img: "../img/foto-convidado8.webp", link: "https://youtu.be/Z3r_hMHdoKY?si=VBxyy3FUotma3fVj" }
];
    ...
    for (let i = 0; i < itemsToShow && i < guestsData.length; i++) {
        ...
        col.innerHTML = `
                    <div class="guest-card w-100">
                        ...
                        <a href="${guest.link}" target="_blank" class="btn-watch">Assista agora</a>
                    </div>
                `;
...
const episodesData = [
    {
        ...
        link: "https://youtu.be/rhN0R9e5aOA?si=i_OlhI47ypqUajPQ"
    },
    {
        ...
        link: "https://youtu.be/Dd4I-6mZoaw?si=4yHEiP7wWbJHeQXI"
    },
    {
    ...
    },
    {
        ...
        link: "https://youtu.be/ZKm_yfhCmn0?si=n_gcrwAzg_y9mTBP"
    }
];
...
function renderEpisodes() {
    episodesData.forEach(episode => {
        ...
        cardWrapper.innerHTML = `
                    ...
                    <div>
                        <a href="${episode.link}" class="btn-watch" target="_blank">Assista agora</a>
                    </div>
                `;
